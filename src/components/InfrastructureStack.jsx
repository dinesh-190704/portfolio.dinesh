  ...
  return (
    <section ref={ref} className="pro-section bg-surface relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground text-tight mb-6 md:mb-8">
            Infrastructure Stack
          </h2>
          <p className="text-lg md:text-xl text-muted max-w-4xl mx-auto text-professional leading-relaxed">
            Enterprise technologies powering secure, scalable infrastructure solutions with proven reliability
          </p>
        </motion.div>
